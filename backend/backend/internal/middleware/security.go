...
func SecurityHeadersMiddleware() gin.HandlerFunc {
	return func(c *gin.Context) {
		...
		path := c.Request.URL.Path
		if strings.Contains(path, "/promoter/") || strings.Contains(path, "/invite/") || strings.Contains(path, "/join/") || strings.Contains(path, "/r/") || strings.Contains(path, "/@") || strings.Contains(path, "/api/invite/") {
